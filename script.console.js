...
script_automate.src = "https://cdn.jsdelivr.net/gh/AyrtonYamashita/script-automate/dist/script.min.js";
document.head.appendChild(script_automate);
(async () => {
  let documentos = [{ "JGS": "01974046" }, { "GYN": "01490856" }, { "POA": "11811458" }];

  const { startAutomate } = await import("https://cdn.jsdelivr.net/gh/AyrtonYamashita/script-automate/dist/script.min.js");
